...
fun LazyTreeList(
    ...
    LazyColumn(
        ...
        flattenItems(items.expand(expansionState), expansionState, onScrollTo = { i ->
...
@DslMarker
public annotation class LazyTreeListMarker

@LazyTreeListMarker
public interface LazyTreeListScope {
    fun items(
        count: Int,
        key: (index: Int) -> Any,
...
public interface TreeItemScope : LazyItemScope {
...
internal fun concatItems(a: ItemTree, b: ItemTree) = object : ItemTree {
    ...
    override fun LazyItemScope.Item(
        ...
        local(index) { items, i -> with(items) { Item(i, depth, placement, expanded, onExpand) } }
    }
